...
test('animationToStyle', () => {
    let animation = _.createAnimation().rotate(45).scale(2, 2).translate(11).skew(9).step().export();
    ...
    animation = _.createAnimation()
        ...
        .scaleX(0.5).scaleY(2).scaleZ(2)
        .translateX(12).translateY(34).translateZ(56)
        .skewX(8).skewY(9)
        .width(20).left('5rpx')
        .step().export();
    expect(utils.animationToStyle(animation.actions[0])).toEqual({
    ...
    animation = _.createAnimation().rotate3d(20, 30, 40).scale3d(1, 2, 0.5).translate3d(20, 44, 56).step().export();
    expect(utils.animationToStyle(animation.actions[0])).toEqual({
        style: {},
